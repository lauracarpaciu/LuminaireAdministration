...
public class LogUserAspect {
    ...
    @AfterReturning(
            pointcut = ("com.laura.carpacu.poitcut.PointcutExpression.userLoginWithEmail() || com.gini.iordache.poitcut.PointcutExpression.userLoginWithUsername()"),
            returning = "auth")
    ...
    @AfterReturning(
            pointcut = ("com.laura.carpacu.poitcut.PointcutExpression.createUser()"),
            returning = "user")
    ...
    @AfterThrowing( pointcut = "execution(* ro.laura.carpacu..email.sender.impl.EmailService.sendEmail(..))",
                   throwing = "exc")
    ...
    @AfterThrowing(value = "com.laura.carpacu.poitcut.PointcutExpression.modulesExceptions()",
                    throwing = "exc")
